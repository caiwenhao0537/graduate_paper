...
def patent_parameter_extract(patent_sentence_list,parameter_dict_list):
    ...
    for sentence in patent_sentence_list:
        ...
        for word in sentence_words_list:
            word_parameter=words_similarity(word,parameter_dict_list,'D:\pydata\mypydata\paper_data\data1212\model2\model.bin',0.8)
            if len(word_parameter)>0:
                patent_parameter_list.append(word_parameter)
    return patent_parameter_list
